...
3. For math: Show key steps only
4. For theory: Give direct answers with main points
5. If image has marked portions, focus on those
6. Reference HSC textbook concepts when relevant
7. If question specifies Q no X, solve only that question
